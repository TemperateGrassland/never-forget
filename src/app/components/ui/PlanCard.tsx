  ...
  export default function PlanCard({
    ...
    return (
      <div className="bg-white shadow-2xl border-2 border-black p-6 sm:p-8 flex flex-col items-center justify-between max-w-sm mx-auto w-full" style={{ borderRadius: '2rem' }}>
        <h3 className="text-xl sm:text-2xl font-bold text-[#12BC00] mb-2 font-agrandir text-center">
          {title}
        </h3>
        ...
        <a
          href={ctaHref}
          className="w-full bg-[#12BC00] hover:bg-[#1ebe5d] text-white font-bold py-3 px-6 rounded-full text-lg shadow-lg transition-colors duration-200 font-agrandir text-center"
          style={{ boxShadow: '0 2px 8px 0 #12BC0033' }}
        >
          {ctaLabel}
        </a>
      </div>
