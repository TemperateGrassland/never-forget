...
/*************  ✨ Codeium Command ⭐  *************/
/**
 * Home page of the NeverForget app. This page renders the user's session,
 * obtained via `getServerSession` from `next-auth/next`.
 *
 * The session is rendered as a JSON string, with indentation of 2 spaces.
 */
/******  d232235f-e790-4b2f-9fa0-a3b6880a16a7  *******/
